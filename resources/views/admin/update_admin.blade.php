...
<body>
    <main class="container py-4 py-md-5" style="max-width: 54rem;">
        <div class="mb-4">
            ...
            <h1 class="mb-1">Update Admin Profile</h1>
            <p class="text-light-emphasis mb-0">Update your administrator account information.</p>
        </div>
        ...
        <section class="glass-card p-4 p-md-5">
            <form action="{{ route('admin.profile.update') }}" method="POST">
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-between gap-2 mt-4 pt-2">
                    ...
                    <button class="btn btn-update-profile" type="submit">Update Profile</button>
                </div>
            </form>
        </section>
    </main>
